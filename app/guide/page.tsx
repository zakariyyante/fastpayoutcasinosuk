  ...
  return (
    <div className="container mx-auto px-4 py-24 max-w-4xl">
      <h1 className="text-4xl font-black text-white mb-8 uppercase italic tracking-tighter">
        Casino <span className="text-accent">Guide</span>
      </h1>
      <div className="prose prose-invert max-w-none text-white/70 space-y-6">
        <p>Finding the right new casino is a top priority for UK players. Here is our guide to choosing the best new brands.</p>
